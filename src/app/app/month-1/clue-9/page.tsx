...
/* ── config ──────────────────────────────────────────── */
const LINES = [
  { encrypted: "HQHDQRU UHHG EDVHPHQW UHFRUGHU", answer: "ELEANOR REED BASEMENT RECORDER" },
  { encrypted: "QRYHPEHU 1963", answer: "NOVEMBER 1963" },
  { encrypted: "IRUWB VLA KRXUV", answer: "FORTY SIX HOURS" },
];
        ...
        <div className="px-12 pt-14 pb-12 flex flex-col items-center text-center">
          ...
          {!showReward && !solved && (
            <p className="text-base mb-8" style={{ color: "rgba(230,230,230,0.45)" }}>
              Decode each encrypted field below.
            </p>
          )}
          ...
          {showReward && (
            <div className="w-full text-center" style={{ animation: "fade-in-up 0.8s ease-out both" }}>
              ...
              <h2 className="text-xl tracking-wider mb-6" style={{ fontFamily: font, color: textColor }}>
                TECHNICAL ANALYSIS — RECORDING DEVICE DECODED
              </h2>
