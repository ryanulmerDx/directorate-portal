...
/* ── config ──────────────────────────────────────────── */
const LINES = [
  { encrypted: "WKHVH LQGLYLGXDOV VKRZ HAFHSWLRQDOOB KLJK PRUDO UHDVRQLQJ VFRUHV", answer: "THESE INDIVIDUALS SHOW EXCEPTIONALLY HIGH MORAL REASONING SCORES" },
  { encrypted: "FDQGLGDWHV DUH DOUHDGB TXHVWLRQLQJ WKH UHFUXLWPHQW QDUUDWLYH", answer: "CANDIDATES ARE ALREADY QUESTIONING THE RECRUITMENT NARRATIVE" },
  { encrypted: "UHFRPPHQGDWLRQ: FRQVLGHU FDQGLGDWHV ZLWK PRUH IOHALEOH HWKLFDO IUDPHZRUNV", answer: "RECOMMENDATION CONSIDER CANDIDATES WITH MORE FLEXIBLE ETHICAL FRAMEWORKS" },
];
...
export default function M1C10() {
  ...
  const [correct, setCorrect] = useState<boolean[]>([false, false, false]);
        ...
        <div className="px-12 pt-14 pb-12 flex flex-col items-center text-center">
          ...
          {!showReward && !solved && (
            <p className="text-base mb-8" style={{ color: "rgba(230,230,230,0.45)" }}>
              Decode each encrypted assessment below.
            </p>
          )}
